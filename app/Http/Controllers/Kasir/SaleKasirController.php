...
class SaleKasirController extends Controller
{
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($sales)
                ...
                ->addColumn('aksi', function ($row) {
                    $edit = route('kasir.transaksi.edit', $row->id);
                    $invoice = route('kasir.transaksi.invoice', $row->id);
                    $delete = route('kasir.transaksi.destroy', $row->id);
                    return '
    ...
    public function create()
    {
        ...
        return view('kasir.transaksi.create', compact('title', 'products', 'categories', 'invoice_number', 'saleItems'));
    }
    ...
    public function update(Request $request, Sale $sale)
    {
        ...
        try {
            ...
            DB::commit();
            Log::info('--- Update transaksi berhasil ---');
            return redirect()->route('kasir.transaksi')->with('success', 'Transaksi berhasil diperbarui.');
    ...
    public function generateReport(Request $request)
    {
        ...
        return view('kasir.sales.reports', compact('sales', 'title'));
    }
